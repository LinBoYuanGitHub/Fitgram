...
class CookingStepViewController: UIViewController {
    ...
    var stepLabel = UILabel(frame: CGRect(x: 16, y:  50, width: UIScreen.main.bounds.width - 32, height: UIScreen.main.bounds.height-50))
    var image = UIImage()
    var stepText = ""
...
//        stepImage.kf.setImage(with: URL(string: imageUrl))
        ...
        if isLast {
            ...
            checkBtn.setTitle("Log Food", for: .normal)
